...
export function DockTabBar(props) {
    const { onDragStart, onDragMove, onDragEnd, TabNavList, isMaximized, className } = props, restProps = __rest(props, ["onDragStart", "onDragMove", "onDragEnd", "TabNavList", "isMaximized", "className"]);
    ...
    return (React.createElement(DragDropDiv, { onDragStartT: onDragStart, onDragMoveT: onDragMove, onDragEndT: onDragEnd, role: "tablist", className: "dock-bar" + (className ? (" " + className) : ""), onKeyDown: onKeyDown, getRef: getRef, tabIndex: -1 },
